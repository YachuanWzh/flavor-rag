...
> 版本：v0.0.4 | 日期：2026-07-28 | 状态：生产就绪（144/144 测试全绿）
...
> **文档维护**：本文档基于 `flavorag-server/app/` 下的实际源码编写，与代码保持同步更新。各版本特性：v0.0.2 批量导入/异步摄取/增量索引，v0.0.3 HyDE 假设文档嵌入，v0.0.4 Mem0 长期记忆与用户画像。
