...
> 版本：v0.0.5 | 日期：2026-07-28 | 状态：企业级 RAG 数据面加固（181/181 后端测试、前端生产构建、空库迁移验证通过）
...
> **文档维护**：本文档基于 `flavorag-server/app/` 下的实际源码编写，与代码保持同步更新。各版本特性：v0.0.2 批量导入/异步摄取/增量索引，v0.0.3 HyDE 假设文档嵌入，v0.0.4 Mem0 长期记忆与用户画像，v0.0.5 非破坏索引 generation、一致性摄取、持久化任务、企业评测、共享源存储与生产运维加固。
